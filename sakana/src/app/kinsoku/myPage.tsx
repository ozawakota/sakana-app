    ...
    <section className="p-4 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border mt-4 p-2 bg-white text-black w-[420px] kinsoku">
          <p>
          親譲りの無鉄砲で小供の時から損ばかりしている。<span className="safari-decoration-line !underline decoration-solid inline-block">小学校</span>に居る時分学校の二階から飛び降りて一週間ほど腰を抜かした事がある。なぜそんな無闇をしたと聞く人があるかも知れぬ。別段深い理由でもない。新築の二階から首を出していたら、「同級生」の一人が「冗談」に、いくら威張っても、そこから飛び降りる事は出来まい。弱虫やーい。と囃したからである。<span className='safari-decoration-line !underline decoration-wavy'>小使に負ぶさって帰って来た時</span>、おやじが大きな眼をして二階ぐらいから飛び降りて腰を抜かす奴があるかと云ったから、この次は抜かさずに飛んで見せますと答えた。（青空文庫より）
          </p>
        </div>
        ...
        <div className="border mt-4 p-2 [writing-mode:vertical-rl] h-[205px] w-[500px] bg-white text-black overflow-y-auto kinsoku ">
          ...
          <ruby>
              <rb>親譲</rb>
              <rt>おやゆず</rt>
            </ruby>りの無鉄砲で<u className="safari-decoration-line">小供の時</u>から損ばかりしている。<span className="safari-decoration-line underline decoration-solid inline-block">小学校</span>に居る時分学校の<span className="inline-block">二階</span>から飛び降りて一週間ほど腰を抜かした事がある。なぜそんな無闇をしたと聞く人があるかも知れぬ。別段深い<span className="inline-block">理由</span>でもない。新築の二階から首を出していたら、「同級生」の一人が<span className="inline-block">「冗談」</span>に、いくら威張っても、そこから飛び降りる事は出来まい。弱虫やーい。と囃したからである。<span className='safari-decoration-line decoration-wavy'>小使に負ぶさって帰って来た時</span>、おやじが大きな眼をして二階ぐらいから飛び降りて腰を抜かす奴があるかと云ったから、この次は抜かさずに飛んで見せますと答えた。（青空文庫より）
          </p>
        </div>
